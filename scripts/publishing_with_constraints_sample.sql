...
UPDATE BOOKS SET price=6.66 WHERE isbn='ISBN1';
#UPDATE BOOKS SET price=-6.66 WHERE isbn='ISBN1'; #Price Constraint violation
#DELETE FROM PUBLISHERS WHERE PUBLISHERS.NAME='Springer';#Foreign key
