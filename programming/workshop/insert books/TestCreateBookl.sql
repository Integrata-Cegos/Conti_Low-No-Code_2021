...
EXEC CreateBook @isbn1=10, @isbn2=11, @isbn3=12, @isbn4=15, @price=19.99, @title='a specialist book', @category = 'ectoplasma'
select * from PUBLISHING_BOOKS where isbn1 = 10
select * from PUBLISHING_SPECIALISTBOOK

EXEC CreateBook @isbn1=10, @isbn2=11, @isbn3=12, @isbn4=16, @price=19.99, @title='a school book', @year = 10, @subject='ectoplasma'
select * from PUBLISHING_BOOKS where isbn1 = 10
